...
export const blogPosts: BlogPost[] = [
  {
    slug: 'office-sensory-audit-checklist',
    title: 'Office Sensory Audit Checklist: 30 Checks for a Neuro-Inclusive Workplace',
    date: 'September 23, 2026',
    excerpt: 'A practical, room-by-room sensory audit checklist for UK offices, covering noise, lighting, smell, layout and predictability — with a free scored version you can run today.',
    heroImage: '/blog/office-sensory-audit-checklist-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "Office Sensory Audit Checklist" and the subheading "30 checks, room by room"',
    keywords: 'sensory audit checklist, office sensory audit, sensory friendly office, neuro-inclusive workplace checklist, autism friendly office audit, workplace sensory assessment UK',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> a sensory audit walks every area of your office and scores it on five things — noise, light, smell, space and predictability — then fixes the worst-scoring areas first. You need no specialist kit to start: a phone decibel app, a notepad and an hour per floor. Use the checklist below, or run the <a href="/tools/sensory-self-assessment/">free scored self-assessment</a> to get a result straight away.' },
      { type: 'heading', level: 2, id: 'why-audit', text: 'Why run a sensory audit?' },
      { type: 'paragraph', text: 'Noise, lighting and unpredictability are the barriers neurodivergent employees name first. Under the Equality Act 2010, employers must make reasonable adjustments once they know, or ought reasonably to know, that someone is disadvantaged — and most environmental adjustments cost very little. An audit turns vague complaints ("it\'s too loud") into a prioritised, costed list.' },
      { type: 'heading', level: 2, id: 'noise', text: 'Noise (8 checks)' },
      { type: 'list', items: [
        'Is there at least one enclosed room anyone can book for focused work without a reason?',
        'Are desks placed away from kitchens, printers, lifts and main walkways?',
        'Does the open-plan area stay below roughly 55 dB during a normal busy hour?',
        'Are hard surfaces softened with carpet, acoustic panels or soft furnishings?',
        'Is there a written quiet-zone etiquette (no calls, no loud conversations)?',
        'Are phone and video calls moved into booths or rooms?',
        'Are building alarms and tests announced in advance?',
        'Can people use noise-cancelling headphones without it being seen as rude?',
      ] },
      { type: 'heading', level: 2, id: 'lighting', text: 'Lighting (6 checks)' },
      { type: 'list', items: [
        'Do any lights flicker or hum?',
        'Can individuals dim or switch off the light above their own desk?',
        'Is there natural light, with blinds to control glare?',
        'Are there desk positions away from direct overhead fluorescent tubes?',
        'Are screens adjustable for brightness and colour temperature?',
        'Is there a low-light area for recovery?',
      ] },
      { type: 'heading', level: 2, id: 'smell-temperature', text: 'Smell and temperature (5 checks)' },
      { type: 'list', items: [
        'Is food eaten away from desks, in a ventilated area?',
        'Are cleaning products and air fresheners low-scent?',
        'Is there a fragrance-considerate guideline for shared spaces?',
        'Can people move to a cooler or warmer spot?',
        'Is ventilation adequate in meeting rooms when full?',
      ] },
      { type: 'heading', level: 2, id: 'space-layout', text: 'Space and layout (6 checks)' },
      { type: 'list', items: [
        'Can people keep a consistent desk if hot-desking causes distress?',
        'Are there screened or high-backed desks for visual privacy?',
        'Is signage clear, consistent and easy to follow?',
        'Are there routes through the office that avoid crowded areas?',
        'Is there a quiet recovery room that is not also used for meetings?',
        'Are lifts and entrances usable without queuing in crowds at peak times?',
      ] },
      { type: 'heading', level: 2, id: 'predictability', text: 'Predictability (5 checks)' },
      { type: 'list', items: [
        'Are office changes (moves, refurbishments, new layouts) announced with notice?',
        'Do meetings have agendas sent in advance?',
        'Is a visual map or virtual tour available for new starters and visitors?',
        'Are busy days (all-hands, events) published in advance?',
        'Is there one named person to raise environmental issues with?',
      ] },
      { type: 'heading', level: 2, id: 'scoring', text: 'How to score and prioritise' },
      { type: 'table', headers: ['Result', 'What it means', 'What to do first'], rows: [
        ['25–30 yes', 'Strong sensory provision', 'Publish it — candidates and staff look for this'],
        ['15–24 yes', 'Workable, with gaps', 'Fix noise and a bookable quiet room first'],
        ['Under 15 yes', 'Likely to exclude people', 'Offer assessed external space while you fix the office'],
      ] },
      { type: 'protip', text: 'Ask neurodivergent staff to walk the audit with you. They will spot things a checklist cannot — like which corner of the kitchen has the buzzing fridge.' },
      { type: 'paragraph', text: 'If your office cannot fix the basics quickly, <a href="/spaces/">assessed quiet workspaces</a> are a legitimate adjustment in the meantime. Workspace providers can <a href="/workspace-providers/">list their space for free</a> and apply for the full NeuroFlow assessment.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Who should carry out a sensory audit?', answer: 'Anyone can run a first pass — facilities, HR or an inclusion lead — ideally with neurodivergent colleagues. For certification, an independent assessment such as NeuroFlow measures noise, light and layout against a consistent standard.' },
      { type: 'faq', question: 'How often should we repeat it?', answer: 'After any office move or refurbishment, and at least once a year.' },
      { type: 'faq', question: 'Is a sensory audit a legal requirement?', answer: 'Not in itself, but it is strong evidence that you are meeting the reasonable-adjustments duty under the Equality Act 2010.' },
    ]
  },
  {
    slug: 'reasonable-adjustments-neurodivergent-employees-uk-law',
    title: 'Reasonable Adjustments for Neurodivergent Employees: The UK Legal Position Explained',
    date: 'September 23, 2026',
    excerpt: 'What the Equality Act 2010 actually requires of UK employers for autistic, ADHD and dyslexic staff — when the duty starts, what counts as reasonable, and how to document it.',
    heroImage: '/blog/reasonable-adjustments-neurodivergent-employees-uk-law-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "Reasonable Adjustments: The UK Legal Position" and the subheading "Equality Act 2010 explained for employers"',
    keywords: 'reasonable adjustments neurodivergent, reasonable adjustments autism UK, ADHD reasonable adjustments work, Equality Act 2010 neurodiversity, reasonable adjustments law UK, Access to Work neurodiversity',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> under the Equality Act 2010, a UK employer must make reasonable adjustments when a neurodivergent employee or candidate is put at a substantial disadvantage by a working practice, the physical environment, or the lack of an aid — and the employer knows, or could reasonably be expected to know, about the disability. A formal diagnosis is not required. This article is general information, not legal advice.' },
      { type: 'heading', level: 2, id: 'is-it-a-disability', text: 'Does neurodivergence count as a disability?' },
      { type: 'paragraph', text: 'Often, yes. The Act defines disability as a physical or mental impairment with a substantial and long-term adverse effect on normal day-to-day activities. Autism, ADHD, dyslexia and dyspraxia frequently meet that test, and tribunals look at the effect without any coping strategies or medication. Employers should assume the duty may apply rather than debate the label.' },
      { type: 'heading', level: 2, id: 'when-duty-starts', text: 'When does the duty start?' },
      { type: 'list', items: [
        'When the employee tells you — in any form, not only in a formal request.',
        'When you ought reasonably to know — for example, repeated difficulties clearly linked to a condition.',
        'For candidates, as soon as they ask for an adjustment to the recruitment process.',
      ] },
      { type: 'heading', level: 2, id: 'what-is-reasonable', text: 'What counts as "reasonable"?' },
      { type: 'paragraph', text: 'Tribunals weigh how effective the adjustment would be, how practical it is, its cost against your resources, and what funding is available. Most adjustments for neurodivergent staff cost little or nothing.' },
      { type: 'table', headers: ['Barrier', 'Typical adjustment', 'Typical cost'], rows: [
        ['Open-plan noise', 'Quiet desk, bookable room, headphones, access to quiet external space', 'Low'],
        ['Lighting', 'Desk away from fluorescents, dimmable lamp', 'Low'],
        ['Verbal instructions', 'Written task lists and meeting notes', 'None'],
        ['Rigid hours', 'Flexible start times, hybrid pattern', 'None'],
        ['Interviews', 'Questions in advance, extra time, quiet waiting area', 'None'],
        ['Specialist support', 'Coaching, assistive software', 'Often funded by Access to Work'],
      ] },
      { type: 'paragraph', text: '<a href="https://www.gov.uk/access-to-work" target="_blank" rel="noopener noreferrer">Access to Work</a> is a government grant that can pay for support beyond what is reasonable for the employer to fund, including coaching and some travel costs.' },
      { type: 'heading', level: 2, id: 'other-claims', text: 'The claims employers overlook' },
      { type: 'paragraph', text: 'Most neurodiversity claims are not only about refused adjustments. "Discrimination arising from disability" covers penalising behaviour caused by the condition — lateness, bluntness, missed social cues — unless the employer can justify it. Neurodiversity-related tribunal claims have risen sharply in recent years, and undocumented informal refusals are a common thread.' },
      { type: 'heading', level: 2, id: 'how-to-document', text: 'How to handle a request well' },
      { type: 'list', items: [
        'Acknowledge in writing within a few days.',
        'Meet to understand the barrier, not the diagnosis.',
        'Agree adjustments, an owner and a review date, and write them down (a workplace adjustments passport works well).',
        'If you decline something, give reasons in writing and offer an alternative.',
        'Review after a set period — adjustments that are agreed but never implemented are the most common failure.',
      ] },
      { type: 'protip', text: 'If your office cannot provide a quiet enough environment, funding time in an assessed external workspace can be a reasonable adjustment. See <a href="/quiet-workspaces/london/">quiet workspaces in London</a>.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Does an employee need a diagnosis to get adjustments?', answer: 'No. The duty depends on the effect of the impairment and the employer\'s knowledge, not on a formal diagnosis.' },
      { type: 'faq', question: 'Can an employer refuse because of cost?', answer: 'Only if the cost is genuinely unreasonable given the employer\'s size and resources and available funding such as Access to Work. Most adjustments are cheap, so cost is rarely a safe reason.' },
      { type: 'faq', question: 'Where can I get free advice?', answer: 'Acas publishes free guidance on reasonable adjustments and neurodiversity at work.' },
    ]
  },
  {
    slug: 'adhd-friendly-office',
    title: 'What Makes an Office ADHD-Friendly? A Practical Guide for UK Employers',
    date: 'September 23, 2026',
    excerpt: 'ADHD-friendly offices reduce distraction, support focus and give people control. Here are the layout, noise, tech and management changes that make the biggest difference.',
    heroImage: '/blog/adhd-friendly-office-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "What Makes an Office ADHD-Friendly?" and the subheading "Focus, control and fewer interruptions"',
    keywords: 'ADHD friendly office, ADHD workplace adjustments, ADHD office design, ADHD at work UK, focus space ADHD, neurodivergent office design',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> an ADHD-friendly office cuts unplanned interruptions, offers a choice of places to work (quiet and enclosed as well as lively), makes priorities visible, and lets people move. The goal is not silence everywhere — it is giving each person control over how much stimulation they get.' },
      { type: 'heading', level: 2, id: 'distraction', text: 'Reduce distraction, not people' },
      { type: 'list', items: [
        'Desks away from walkways, kitchens and doors — movement in peripheral vision is a major focus-breaker.',
        'Bookable focus rooms or booths, available without justification.',
        'Protected focus blocks in the team calendar, with messages rather than drop-ins.',
        'Notifications off by default on shared tools; agreed response times for chat.',
      ] },
      { type: 'heading', level: 2, id: 'choice', text: 'Offer a choice of environments' },
      { type: 'paragraph', text: 'Many people with ADHD work best by switching settings: a quiet room for deep work, a busier area for routine tasks, standing or walking for calls. A single uniform open-plan floor forces everyone into one mode.' },
      { type: 'table', headers: ['Work type', 'Best setting', 'Why'], rows: [
        ['Deep focus', 'Enclosed quiet room', 'Removes visual and auditory interruption'],
        ['Routine admin', 'Quiet zone or own desk', 'Low stakes, moderate stimulation is fine'],
        ['Collaboration', 'Team area or meeting room', 'Energy of others helps'],
        ['Calls', 'Booth or standing desk', 'Movement can aid attention'],
      ] },
      { type: 'heading', level: 2, id: 'visible-priorities', text: 'Make time and priorities visible' },
      { type: 'list', items: [
        'One written task list, ranked, with a named owner per task.',
        'Visible clocks and timers in meeting rooms.',
        'Agendas sent in advance; actions sent in writing afterwards.',
        'Deadlines broken into milestones with a mid-point check-in.',
      ] },
      { type: 'heading', level: 2, id: 'movement', text: 'Allow movement and fidgeting' },
      { type: 'paragraph', text: 'Standing desks, walking one-to-ones, and simply normalising getting up are cheap changes that help attention. So is tolerance for fidget tools and doodling in meetings.' },
      { type: 'protip', text: 'Audit your office against the <a href="/blog/office-sensory-audit-checklist/">sensory audit checklist</a> — noise and interruptions score highest for ADHD.' },
      { type: 'paragraph', text: 'If the office cannot offer a real quiet option, <a href="/spaces/">NeuroIndex-assessed workspaces</a> can fill the gap. For the wider picture, see our guide for <a href="/for/managers/">managers</a>.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Is open-plan bad for ADHD?', answer: 'Not always, but open plan without quiet alternatives usually is. The fix is choice: keep collaborative areas and add enclosed focus space.' },
      { type: 'faq', question: 'Are these reasonable adjustments?', answer: 'Often, yes. Where ADHD meets the Equality Act definition of disability, changes like a quiet desk or flexible hours are classic reasonable adjustments.' },
    ]
  },
  {
    slug: 'quiet-working-spaces-london-what-to-look-for',
    title: 'Quiet Working Spaces in London: What to Look For Before You Book',
    date: 'September 23, 2026',
    excerpt: 'Most London coworking spaces call themselves quiet. Here is how to check before you book — noise, lighting, layout and booking questions that separate genuinely quiet spaces from marketing copy.',
    heroImage: '/blog/quiet-working-spaces-london-what-to-look-for-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "Quiet Working Spaces in London" and the subheading "What to look for before you book"',
    keywords: 'quiet working spaces London, quiet coworking London, quiet office space London, sensory friendly workspace London, neurodivergent friendly coworking London, quiet place to work London',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> a genuinely quiet London workspace has enclosed rooms or a policed silent zone, phone booths so calls happen elsewhere, soft surfaces that absorb sound, controllable lighting, and a layout that keeps you away from the café and front desk. Ask about those five things before you book. Or go straight to <a href="/quiet-workspaces/london/">NeuroIndex-assessed quiet workspaces in London</a>.' },
      { type: 'heading', level: 2, id: 'questions', text: 'Questions to ask before booking' },
      { type: 'list', items: [
        'Is there a silent zone, and how is it enforced?',
        'How many phone booths per member, and are calls banned at desks?',
        'Where is the café, bar or event space relative to the quiet area?',
        'Can I control the lighting at my desk or in my room?',
        'What are the busiest days and times?',
        'Can I visit at a busy time before committing?',
      ] },
      { type: 'heading', level: 2, id: 'red-flags', text: 'Red flags' },
      { type: 'table', headers: ['What you see', 'Why it matters'], rows: [
        ['Polished concrete, glass and exposed ceilings everywhere', 'Sound bounces; the room gets louder as it fills'],
        ['Café or bar in the middle of the floor', 'Constant noise, smell and movement'],
        ['"Quiet zone" that is just a sign', 'No enforcement means no quiet'],
        ['Frequent evening events', 'Set-up and noise often start mid-afternoon'],
        ['Hot-desking only', 'No predictability about where you sit'],
      ] },
      { type: 'heading', level: 2, id: 'good-signs', text: 'Good signs' },
      { type: 'list', items: [
        'Carpet, acoustic panels, soft furnishings.',
        'Bookable private rooms by the hour.',
        'Clear written etiquette for quiet areas.',
        'Staff who can tell you the quietest times without guessing.',
        'An independent assessment score rather than marketing adjectives.',
      ] },
      { type: 'protip', text: 'Visit on a Tuesday or Wednesday late morning — typically the busiest time in London coworking — to hear the space at its worst.' },
      { type: 'paragraph', text: 'Every space on NeuroIndex carries a score for noise, lighting and sensory load, so you can compare without visiting. <a href="/spaces/">Browse all assessed spaces</a>. Run a London workspace? <a href="/workspace-providers/">List it for free</a>.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Can my employer pay for a quiet workspace?', answer: 'Yes — where the office environment disadvantages a disabled employee, funding external quiet space can be a reasonable adjustment.' },
      { type: 'faq', question: 'Are libraries a good alternative?', answer: 'For short sessions, yes, but they rarely allow calls and seats are not guaranteed. A bookable quiet room gives predictability.' },
    ]
  },
  {
    slug: 'cost-of-getting-neuroinclusion-wrong',
    title: 'The Cost of Getting Neuroinclusion Wrong: Tribunals, Turnover and Lost Talent',
    date: 'September 23, 2026',
    excerpt: 'Failing neurodivergent employees costs UK employers in tribunal awards, replacement hiring and lost productivity. Here is how the costs add up — and how cheap prevention is by comparison.',
    heroImage: '/blog/cost-of-getting-neuroinclusion-wrong-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "The Cost of Getting Neuroinclusion Wrong" and the subheading "Tribunals, turnover and lost talent"',
    keywords: 'cost of neuroinclusion, neurodiversity tribunal cost, neurodivergent employee turnover cost, disability discrimination compensation UK, business case neuroinclusion, cost of staff turnover UK',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> getting neuroinclusion wrong costs far more than getting it right. Disability discrimination awards in the UK are uncapped, replacing an employee commonly costs a large share of their annual salary, and most of the adjustments that would have prevented both cost little or nothing.' },
      { type: 'heading', level: 2, id: 'tribunals', text: 'Tribunal risk' },
      { type: 'paragraph', text: 'Disability discrimination compensation has no statutory cap and includes an award for injury to feelings, set in bands that are updated each year. On top of any award come legal fees, management time and reputational damage — employment tribunal judgments are published online. Neurodiversity-related claims have been rising, and the common pattern is an adjustment that was informally agreed and never delivered. Read more in <a href="/blog/neurodiversity-tribunal-risk-uk-2026/">our tribunal risk analysis</a>.' },
      { type: 'heading', level: 2, id: 'turnover', text: 'Turnover' },
      { type: 'paragraph', text: 'Around one in four neurodivergent UK employees say they are considering leaving because of a lack of support. Replacing a skilled employee means recruitment fees, onboarding time and months of reduced output — commonly estimated at between half and a full year of salary.' },
      { type: 'heading', level: 2, id: 'comparison', text: 'Prevention versus cure' },
      { type: 'table', headers: ['Cost of getting it wrong', 'Cost of getting it right'], rows: [
        ['Uncapped tribunal award plus legal fees', 'Written adjustments process: management time only'],
        ['Replacement hire: months of salary', 'Quiet desk or bookable room: low or none'],
        ['Lost productivity from burnout and absence', 'Flexible hours and hybrid patterns: none'],
        ['Reputational damage in hiring', 'Manager training: modest, one-off'],
        ['—', 'Specialist support: often funded by Access to Work'],
      ] },
      { type: 'heading', level: 2, id: 'hidden-costs', text: 'The hidden costs' },
      { type: 'list', items: [
        'Masking and burnout reduce output long before anyone resigns.',
        'Candidates who never apply because the interview process excludes them.',
        'Neurodivergent staff held back from promotion, leaving capability unused.',
      ] },
      { type: 'protip', text: 'Start with the environment: it affects everyone, needs no disclosure, and is usually the cheapest fix. Use the <a href="/tools/sensory-self-assessment/">free sensory self-assessment</a>.' },
      { type: 'paragraph', text: 'For the positive side of the ledger, see <a href="/blog/neuroinclusion-roi-business-case-uk-2026/">the ROI case for neuroinclusion</a> and our <a href="/for/hr-teams/">guide for HR teams</a>.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Is there a cap on disability discrimination awards?', answer: 'No. Unlike unfair dismissal, discrimination compensation in the UK is uncapped.' },
      { type: 'faq', question: 'What is the cheapest way to reduce risk?', answer: 'A clear, written adjustments process with named owners and review dates, plus a quiet place to work.' },
    ]
  },
  {
    slug: 'neuroinclusive-interview-guide',
    title: 'How to Run a Neuroinclusive Interview: A Step-by-Step Guide for Hiring Managers',
    date: 'September 23, 2026',
    excerpt: 'Traditional interviews test social performance, not ability. Here is how to run a neuroinclusive interview — before, during and after — so you hire on skill, not eye contact.',
    heroImage: '/blog/neuroinclusive-interview-guide-hero.svg',
    heroImageAlt: 'Dark teal graphic with the headline "How to Run a Neuroinclusive Interview" and the subheading "Hire on skill, not eye contact"',
    keywords: 'neuroinclusive interview, neurodivergent interview adjustments, autism friendly interview, ADHD interview tips employers, inclusive recruitment neurodiversity, interview reasonable adjustments UK',
    content: [
      { type: 'paragraph', text: '<strong>Short answer:</strong> a neuroinclusive interview tells candidates exactly what will happen, shares questions or topics in advance, asks direct questions one at a time, holds it in a quiet room, and scores answers on content rather than eye contact or small talk. Every candidate benefits, and it is a straightforward reasonable adjustment under the Equality Act 2010.' },
      { type: 'heading', level: 2, id: 'before', text: 'Before the interview' },
      { type: 'list', items: [
        'Send a clear schedule: who, where, how long, what format, and what will be assessed.',
        'Share the questions or topics at least 24 hours ahead.',
        'Include photos of the building entrance and room, or a short directions note.',
        'Ask every candidate: "Is there anything we can adjust to help you do your best?"',
        'Offer a choice of video or in-person where the role allows.',
      ] },
      { type: 'heading', level: 2, id: 'during', text: 'During the interview' },
      { type: 'table', headers: ['Instead of', 'Try'], rows: [
        ['"Tell me about yourself"', '"Tell me about a project in your last role that you are proud of"'],
        ['Multi-part questions', 'One question at a time; offer to repeat'],
        ['Hypotheticals ("What would you do if…")', 'Past examples or a practical task'],
        ['Judging eye contact and small talk', 'Scoring only on the criteria you published'],
        ['A bright, busy room', 'A quiet room with controllable lighting'],
      ] },
      { type: 'list', items: [
        'Allow thinking time; silence is not a bad answer.',
        'Let candidates bring notes and a drink.',
        'Offer a short break in longer sessions.',
        'Use the same structured scoring sheet for everyone.',
      ] },
      { type: 'heading', level: 2, id: 'after', text: 'After the interview' },
      { type: 'list', items: [
        'Tell candidates when they will hear back, and keep to it.',
        'Give specific written feedback where you can.',
        'Carry agreed interview adjustments into onboarding, so the successful candidate does not have to ask twice.',
      ] },
      { type: 'protip', text: 'Need a quiet, neutral venue for interviews? <a href="/spaces/">Assessed quiet meeting rooms</a> remove the sensory load of a busy office reception.' },
      { type: 'paragraph', text: 'For the wider people-process view, see our <a href="/for/hr-teams/">guide for HR teams</a> and <a href="/blog/reasonable-adjustments-neurodivergent-employees-uk-law/">reasonable adjustments: the UK legal position</a>.' },
      { type: 'heading', level: 2, id: 'faq', text: 'Frequently asked questions' },
      { type: 'faq', question: 'Is sharing questions in advance unfair to other candidates?', answer: 'No — share them with everyone. It tests preparation and substance rather than improvisation under pressure, which is rarely what the job needs.' },
      { type: 'faq', question: 'Do candidates have to disclose to get adjustments?', answer: 'They only need to say what would help. Asking every candidate the same adjustments question removes the need to disclose a diagnosis.' },
    ]
  },
  {
  ...
  {
    slug: 'managing-neurodivergent-employees',
    title: 'Managing Neurodivergent Employees: A Practical Guide for UK Managers (2026)',
    date: 'September 2, 2026',
    excerpt: 'Around one in four of your team is neurodivergent, and 35% of UK workers say their employer is failing on manager training. This is what to actually do — in disclosure conversations, one-to-ones, feedback, workload and progression.',
    heroImage: '/blog/managing-neurodivergent-employees-hero.svg',
    heroImageAlt: 'Dark teal graphic titled "Managing Neurodivergent Employees: A Practical Manager\'s Guide for 2026" listing disclosure conversations, adjustments, one-to-ones, feedback, workload and progression',
    ...
    content: [
      ...
      { type: 'list', items: [
        'Thank them, and say plainly that it will not affect how their work is judged.',
        'Ask one question: "What would make the biggest difference to your working day?" Do not ask about diagnosis, medication or severity.',
        'Do not say "we all struggle with that" or "you don\'t seem autistic". Both land as dismissal, however they were meant.',
        'Agree what you will do and by when, before the meeting ends.',
        'Confirm in writing the same day, and ask who else they are happy to share it with. Never pass it on beyond that.',
      ]},
      { type: 'protip', text: 'Do not wait for disclosure to make changes. Sending agendas in advance, following verbal instructions with a short written summary, and protecting focus time cost nothing, help the whole team, and remove the need for anyone to disclose in order to get basic conditions.' },
      { type: 'heading', level: 2, id: 'the-first-48-hours', text: 'The first 48 hours after a request' },
      { type: 'table',
        headers: ['Timeframe', 'What the manager does'],
        rows: [
          ['Same day', 'Written acknowledgement confirming what was asked for'],
          ['Within 48 hours', 'Approve anything within your own authority — headphones, seating change, schedule change, meeting format'],
          ['Within 5 working days', 'Route anything larger to the named adjustments owner, with a date and a copy to the employee'],
          ['Within 20 working days', 'Implemented, or declined in writing with reasons and an alternative offered'],
          ['At 6 weeks', 'Check whether the adjustment is actually working, and adjust it'],
        ]
      },
      { type: 'paragraph', text: 'The most common failure is not refusal — it is the informal yes that never gets implemented. The employee reads that as a no, stops asking, and starts looking. Nearly one in four neurodivergent UK employees say they are planning to leave, and replacing them costs six to nine months of salary.' },
      { type: 'heading', level: 2, id: 'day-to-day-management', text: 'Day-to-day management practices that work' },
      { type: 'table',
        headers: ['Situation', 'What tends to fail', 'What works instead'],
        rows: [
          ['Assigning work', 'Verbal briefing in a corridor, priorities implied', 'One written task list, explicitly ranked, one owner per task'],
          ['One-to-ones', 'Open-ended "how are things?"', 'Fixed agenda sent in advance, same slot each week'],
          ['Feedback', 'Sandwiched hints and social cues', 'Specific, behavioural, direct, in writing after the conversation'],
          ['Meetings', 'Ad-hoc invites, no agenda, camera-on expectation', 'Agenda 24 hours ahead, camera optional, notes and actions circulated'],
          ['Deadlines', 'Single distant deadline', 'Milestones and a check-in halfway, without micromanaging the method'],
          ['Interruptions', 'Tapping someone on the shoulder mid-task', 'Asynchronous messages plus agreed protected focus blocks'],
        ]
      },
      ...
      { type: 'list', items: [
        ...
        'Most claims are for discrimination arising from disability: penalising lateness, communication style or absence that stems from the condition.',
        'Cost is rarely a valid reason to decline: most adjustments cost under £100, and Access to Work can fund more.',
        'Always give reasons in writing when declining, and offer an alternative. Neurodiversity-related tribunal claims have risen 164% in four years, and undocumented informal refusals are the pattern that appears in them.',
      ]},
      { type: 'heading', level: 2, id: 'progression', text: 'Do not stall their career' },
      { type: 'paragraph', text: 'Neurodivergent employees are markedly under-represented in UK management. It is rarely a single decision — it accumulates through vague promotion criteria such as "presence" or "cultural fit", stretch work handed to whoever is loudest in the meeting, and managers quietly deciding someone would not cope with leadership. Score promotions against explicit, observable criteria, offer development opportunities in writing rather than in the corridor, and check your own team\'s progression data.' },
      { type: 'heading', level: 2, id: 'faqs', text: 'Frequently asked questions' },
      { type: 'faq', question: 'How should a manager respond when an employee discloses they are neurodivergent?', answer: 'Thank them, confirm it will not affect how their work is judged, and ask what would make the biggest difference to their working day. Do not ask about diagnosis or severity. Agree a specific next step before the conversation ends, confirm it in writing the same day, and keep the disclosure confidential unless they agree otherwise.' },
      { type: 'faq', question: 'What adjustments can a line manager approve without HR?', answer: 'In most organisations a manager can approve low-cost, low-friction changes immediately: noise-cancelling headphones, a seating move, adjustable task lighting, flexible start times, written follow-ups to verbal instructions, agendas in advance and protected focus blocks. Anything requiring budget or assistive technology should be routed to the named adjustments owner within five working days.' },
      { type: 'faq', question: 'Do I need a diagnosis before making adjustments?', answer: 'No. The Equality Act duty is triggered by knowledge the employer has or reasonably ought to have, and waiting for a diagnosis in a system with long waiting lists is both bad practice and legally risky. Respond to the barrier the employee describes rather than to a document.' },
      { type: 'faq', question: 'How do I manage performance concerns with a neurodivergent employee?', answer: 'Separate the outcome from the method. Be specific and direct about the outcome required, put it in writing, and ask what is getting in the way before assuming a capability problem. Check whether agreed adjustments were actually implemented — an unimplemented adjustment is a common root cause of apparent underperformance and a weak position in any subsequent dispute.' },
      { type: 'faq', question: 'What if the whole team wants the same flexibility?', answer: 'Usually a good sign. Most neuro-inclusive practices — written communication, agendas in advance, quiet space, protected focus time — improve conditions for everyone, so extend them as team defaults and keep the individual adjustments that are genuinely specific.' },
    ],
  },
];
